...
class EventDescriptionField extends StatelessWidget {
  ...
  const EventDescriptionField({required this.controller, super.key});
    ...
    children: [
     const Text('Description', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w900)),
      const SizedBox(height: 2),
       Text('Tell your story so participants understand your event', style: TextStyle(color: Colors.grey[600])),
    ],
  ),
),
        ...
        TextField(
          ...
          decoration: InputDecoration(
            hintText: 'Why are you hosting this event? What should participants know?',
            hintStyle: TextStyle(
