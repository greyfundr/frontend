...
//
//     final splitBillDetailsModel = splitBillDetailsModelFromJson(jsonString);

import 'dart:convert';

SplitBillDetailsModel splitBillDetailsModelFromJson(String str) => SplitBillDetailsModel.fromJson(json.decode(str));

String splitBillDetailsModelToJson(SplitBillDetailsModel data) => json.encode(data.toJson());

class SplitBillDetailsModel {
    bool? success;
    String? message;
    Data? data;

    SplitBillDetailsModel({
        this.success,
        this.message,
        this.data,
    });

    factory SplitBillDetailsModel.fromJson(Map<String, dynamic> json) => SplitBillDetailsModel(
...
class Participant {
    ...
    factory Participant.fromJson(Map<String, dynamic> json) => Participant(
        ...
        firstPaidAt: json["firstPaidAt"] == null ? null : DateTime.parse(json["firstPaidAt"]),
        fullyPaidAt: json["fullyPaidAt"] == null ? null : DateTime.parse(json["fullyPaidAt"]),
    ...
    Map<String, dynamic> toJson() => {
        ...
        "firstPaidAt": firstPaidAt?.toIso8601String(),
        "fullyPaidAt": fullyPaidAt?.toIso8601String(),
