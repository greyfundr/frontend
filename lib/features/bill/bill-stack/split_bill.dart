...
class _SplittingBillState extends State<SplittingBill> with SingleTickerProviderStateMixin {
            ...
            Row(
              children: [
                ...
                ElevatedButton(
                  ...
                  child: const Text("Split", style: TextStyle(fontSize: 13)),
                ),
              ],
            ),
...
Gap(10),
 ...
 Row(
  ...
  children: [
              ...
              Text("Split Bills", style: TextStyle(color: const Color.fromARGB(179, 41, 41, 41), fontSize: 20, fontWeight: FontWeight.bold)),
              Gap(10)
            ],),
                        ...
                        Padding(
                          ...
                          child: SizedBox(
                            ...
                            child: ElevatedButton(
                              ...
                              child: const Text('Split', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                            ),
                          ),
                        ),
                      ],
