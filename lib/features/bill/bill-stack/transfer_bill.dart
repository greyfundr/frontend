...
class TransferBill extends StatefulWidget {
  const TransferBill({super.key});

  @override
  State<TransferBill> createState() => _TransferBillState();
}
...
class _TransferBillState extends State<TransferBill> with SingleTickerProviderStateMixin {
...
Gap(10),
 ...
 Row(
  ...
  children: [
              ...
              Text("Transfer Bills", style: TextStyle(color: const Color.fromARGB(179, 41, 41, 41), fontSize: 20, fontWeight: FontWeight.bold)),
              Gap(10)
            ],),
                        ...
                        Padding(
                          ...
                          child: SizedBox(
                            ...
                            child: ElevatedButton(
                              ...
                              child: const Text('Transfer', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                            ),
                          ),
                        ),
                      ],
