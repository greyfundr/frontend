                        ...
                        child: DropdownButtonFormField<String>(
                          ...
                          onChanged: (val) {
                            ...
                            setModalState(() {
                              ...
                              // if switching to manual/custom/by_amount, keep current amounts and allow editing
                            });
                          },
                    ...
                    child: ConstrainedBox(
                      ...
                      child: ListView.separated(
                        ...
                        itemBuilder: (context, i) {
                          ...
                          final editable = modalSelectedMethod == 'by_amount' || modalSelectedMethod == 'custom' || modalSelectedMethod == 'manual';
                      ...
                      ElevatedButton(
                        onPressed: () {
                          try {
                            ...
                            if (modalSelectedMethod == 'manual' || modalSelectedMethod == 'custom' || modalSelectedMethod == 'by_amount') {
